  ...
  async resolveFilePathsFunction(functionName) {
    ...
    return this.resolveFilePathsFromPatterns(
      await this.excludeDevDependencies({
        ...
        include: this.getIncludes(funcPackageConfig.patterns || funcPackageConfig.include),
      })
    );
  },
  ...
  async resolveFilePathsLayer(layerName) {
    ...
    return this.resolveFilePathsFromPatterns(
      await this.excludeDevDependencies({
        ...
        include: this.getIncludes(layerPackageConfig.patterns || layerPackageConfig.include),
      }),
      layerObject.path
    );
  },
