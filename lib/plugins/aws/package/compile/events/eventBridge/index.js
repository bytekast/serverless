          ...
          if (event.eventBridge) {
            ...
            if (!useNativeCloudFormation) {
              this.serverless._logDeprecation(
                ...
                'AWS EventBridge resources are not being created using native CloudFormation, this is now possible and the use of custom resources is deprecated. Set `useNativeCloudFormation: true` in the EventBridge event definition to use this now.'
              );
              ...
              const shouldCreateEventBus =
                !eventBusExists && eventBusName && eventBusName !== 'default';
