...
describe('AwsCompileEventBridgeEvents', () => {
  ...
  describe('#compileEventBridgeEvents()', () => {
            ...
            events: [
              {
                eventBridge: {
                  eventBus:
                    'arn:aws:events:us-east-1:12345:event-bus/aws.partner/partner.com/12345',
                  pattern: {
    ...
    describe('when using native CloudFormation', () => {
              ...
              SourceArn: {
                'Fn::Join': [
                  ...
                  [
                    ...
                    { Ref: 'AWS::AccountId' },
                    {
                      'Fn::Join': ['/', ['event-bus', 'some-event-bus']],
                    },
                  ],
                ],
              },
      ...
      // TODO: Test that only one lambda permission is added if the same event bus triggers the same lambda more than once

      // TODO: Refactor handling of custom and CF eventBridge handling into separate files
