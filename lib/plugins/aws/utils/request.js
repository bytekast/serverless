...
function awsRequest(service, method, params = {}, serviceOptions = {}) {
  ...
  if (
    ...
    enableS3TransferAcceleration(serviceOptions.credentials);
  }
...
function canUseS3TransferAcceleration(service, method) {
  // TODO enable more S3 APIs?
  return service === 'S3' && ['upload', 'putObject'].indexOf(method) !== -1;
}

function enableS3TransferAcceleration(credentials) {
